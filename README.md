...
based on the Fork by tpruvot@github with yescrypt yescryptr8 yescryptr16 yescrypt32 lyra2z330 & lyra2v3 support , and some others, check the [README.txt](README.txt)
